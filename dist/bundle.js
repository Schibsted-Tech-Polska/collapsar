...
/***/ function(module, exports, __webpack_require__) {
	...
	function setup(container, config) {
	  if (container === undefined) {
	    return console.error('[shortener]: You need to provide container.');
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	function render(done) {
	  utils.ajax('http://localhost:3000/', function (code, responseText) {
	...
	function convertResponse(response) {
	  return JSON.parse(response).sort(function (a, b) {
	    return b.total_count - a.total_count;
	  }).slice(0, 4).map(function (article) {
	    return {
	      title: article.title,
	      url: article.url,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  stringToDom: function stringToDom(str) {
